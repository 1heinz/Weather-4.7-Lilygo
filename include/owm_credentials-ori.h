...
String apikey       = "YourOWMapiKey";                      // See: https://openweathermap.org/
const char server[] = "api.openweathermap.org";

//Set your location according to OWM locations
String City             = "YourCity";                      // Your home city See: http://bulk.openweathermap.org/sample/
String Latitude         = "YourLAT";                       // Latitude of your location in decimal degrees
String Longitude        = "YourLONG";                      // Longitude of your location in decimal degrees
